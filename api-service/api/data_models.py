...
class Pagination:
    ...
    def __init__(
        self,
        page_num: int = Query(0, ge=0, description="Page number"),
        page_size: int = Query(
...
class SolutionCreate(BaseModel):
    ...
    diff_equation_details: Optional[dict] = None
    equation_details: Optional[dict] = None
    variable_summary: Optional[str] = None
    usecase_summary: Optional[str] = None
    reference_summary: Optional[str] = None
    training_summary: Optional[str] = None
    other_summary: Optional[str] = None
...
class SolutionStatusComment(BaseModel):
    comment: str
...
class ProjectUserRemoval(BaseModel):
    projectid: int
...
class ProjectDetailsNotification(BaseModel):
    projectname: str
